...
const Support = ({history}) => {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault()
        emailjs.sendForm('service_p7ax9qq', 'template_e7zy0mm', formRef.current, 'ZpUeIRWsJh5UnnWeS')
      .then((result) => {
       ...
       style={{
           ...
           <div>
               ...
               >
                   ...
                   name='user_subject'
                   />
                   <input type="email" name="user_email" placeholder='write your Email ...' required style={{
                       border:"none",
                       outline:"none",
                       width:"100%",
                       borderBottom:"1px solid #3BB77E",
